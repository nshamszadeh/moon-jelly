...
class ScheduleForm(FlaskForm):
	...
	userfirstNamesM1 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesT1 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesW1 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesTh1 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesF1 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	...
	userfirstNamesM2 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesT2 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesW2 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesTh2 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesF2 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	...
	userfirstNamesM3 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesT3 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesW3 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesTh3 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
	userfirstNamesF3 = FieldList(FormField(ScheduleEntryForm), min_entries=1, max_entries = 7)
